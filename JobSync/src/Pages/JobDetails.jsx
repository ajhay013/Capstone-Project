...
<header className="py-4 fixed-top" style={{ height: '100px', marginTop: '130px', backgroundColor: '#F1F2F4' }}>
    <h1 style={{ fontSize: '25px', marginLeft: '300px', textAlign: 'left' }}>Find Job</h1>
</header>
...
const FavoritesAndApplyButton = () => {
  return (
    <div className="d-flex mb-2 mt-5" style={{ marginLeft: '180px', backgroundColor: '#E7F0FA' }}>
